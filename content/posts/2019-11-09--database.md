...
<small>(링크 클릭시 해당 내용으로 이동)</small>
 ...
 + [History of Database](#history-of-database) <br>
    <sub>
      ⋯[Pre-computer](#pre-computer)⋯[1960s](#1960s)⋯[1970s](#1970s)⋯[1980s](#1980s)⋯[1990s](#1990s)⋯[2000s](#2000s)⋯[Today](#Today)
    </sub>
...
## History of Database
  ...
  <p>
    ...
    <ul>
      ...
      <li><b>1992 : Multidimensionak Databse</b></li>
  ...
  ### 2000's
  <p>
    2000년대에 데이터베이스 시장을 주름잡았던 3대 회사는 Microsfot, IBM 그리고 Oracle이다.
    <ul>
